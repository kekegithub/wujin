...
public class MoreFragment extends ABaseFragment {
    ...
    private int[] mImageIcon = { R.drawable.home_popularity_brand, R.drawable.home_user_buy,
            ...
            R.drawable.home_build, R.drawable.home_advertise,R.drawable.home_shop,R.drawable.home_bbs
    };
    private String[] mIconName = { "人气品牌", "用户求购", "商家推广", "行业资讯", "便民维修", "便民施工", "专业招聘", "人气商铺", "社区论坛"};
